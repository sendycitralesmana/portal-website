...
const EditAplikasiPage = () => {
    ...
    function handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        post(route('aplikasi.update', application.id));
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Ubah Aplikasi" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">

                <Card>
                    <CardHeader>
                        <CardTitle>Ubah Aplikasi</CardTitle>
                    </CardHeader>
                    <CardContent>
                            ...
                            <div className=' grid grid-cols-2 gap-4'>
                                ...
                                {/* <div className='col-span-2'>
                                    ...
                                    {data.cover ? (
                                        ...
                                        <div className="mt-2">
                                            <img src={application.cover_url} alt="Preview" className="mt-2 w-32 object-cover rounded" />
                                        </div>
                                    )}
                                </div> */}
                                <div className='col-span-2'>
...
export default EditAplikasiPage
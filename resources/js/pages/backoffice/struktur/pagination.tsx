...
const StructurePagination = ({ structures }: { structures: StructureType }) => {
  ...
  const { prev, next, pages } = createLimitedPagination(structures.links);

  return (
    <div className="flex flex-col items-center justify-between w-full py-2 lg:flex-row">
      <div>
        {structures.from} - {structures.to} of {structures.total}
      </div>

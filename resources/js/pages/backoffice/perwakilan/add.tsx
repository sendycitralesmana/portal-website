...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/backoffice/perwakilan/add',
    },
];
...
const AddPerwakilanPage = () => {
    ...
    function handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        post(route('backoffice.perwakilan.store'));
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Perwakilan" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">

                <Card>
                    <CardHeader>
                        <CardTitle>Tambah Perwakilan</CardTitle>
                    </CardHeader>
                    <CardContent>
...
export default AddPerwakilanPage
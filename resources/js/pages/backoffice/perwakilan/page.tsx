...
import PerwakilanPagination from './pagination';
...
export default function PerwakilanPage() {
  ...
  const handleSearch = useRef(
    debounce((query: string) => {
      router.get('/backoffice/perwakilan', { search: query }, { preserveState: true, replace: true });
    }, 500)
  ).current;
  ...
  const handleDelete = (id: number) => {
    router.delete(`/backoffice/perwakilan/${id}/delete`);
  };
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        <Card className='shadow-md'>
          <CardHeader>
            <CardTitle>Data Perwakilan</CardTitle>
          </CardHeader>
          <CardContent className='space-y-8'>
            <div className='flex items-center justify-between'>
              ...
              <Button>
                <Link href='/backoffice/perwakilan/add' className='flex items-center'>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem asChild>
                            <Link href={`/backoffice/perwakilan/${app.id}/edit`} className='flex items-center'>
                              <PenBox className='ml-1 mr-1' /> Ubah
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href={`/backoffice/perwakilan/${app.id}/detail`} className='flex items-center'>
          ...
          <CardFooter className="flex flex-col items-center justify-between w-full py-2 border-t lg:flex-row">
            <PerwakilanPagination representatives={representatives} />
          </CardFooter>
        </Card>
      </div>
    </AppLayout>

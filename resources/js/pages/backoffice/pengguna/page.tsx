...
import PenggunaPagination from './pagination';
import { Badge } from '@/components/ui/badge';

const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Pengguna', href: '/backoffice/pengguna' },
];
...
export default function PenggunaPage() {
  ...
  const handleSearch = useRef(
    debounce((query: string) => {
      router.get('/backoffice/pengguna', { search: query }, { preserveState: true, replace: true });
    }, 500)
  ).current;
  ...
  const handleDelete = (id: number) => {
    router.delete(`/backoffice/pengguna/${id}/delete`);
  };

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Pengguna">
          <meta name="description" content="Halaman Pengguna" />
        ...
        <Card className='shadow-md'>
          ...
          <CardContent className='space-y-8'>
            <div className='flex items-center justify-between'>
              ...
              <Button>
                <Link href='/backoffice/pengguna/add' className='flex items-center'>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem asChild>
                            <Link href={`/backoffice/pengguna/${app.id}/edit`} className='flex items-center'>
          ...
          <CardFooter className="flex flex-col items-center justify-between w-full py-2 border-t lg:flex-row">
            <PenggunaPagination users={users} />
          </CardFooter>
        </Card>
      </div>
    </AppLayout>

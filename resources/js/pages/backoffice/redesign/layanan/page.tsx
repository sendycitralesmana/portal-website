...
import LayananPagination from './pagination';

const LayananPage = (props: any) => {
    const { data: layanans = [], meta } = props.layanans ?? {};
                            ...
                            <Table className="w-full table-auto">
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead>
                                            <Button variant="ghost" onClick={() => onSortable('link')}>
                                                Link
                                                <IconArrowsDownUp className="ml-2 size-4" />
                                            </Button>
                                        </TableHead>
                                ...
                                <TableBody>
                                    {isLoading ? (
                                        ...
                                        layanans.map((item: any, index: number) => (
                                            <TableRow key={item.id}>
                                                ...
                                                <TableCell className="align-top break-words whitespace-normal">{item.link}</TableCell>

...
import { FileText, Pencil, Plus, Search as SearchIcon, Users } from 'lucide-react'
...
const PejabatStrukturalPage = (props: any) => {
    const { data: pejabatStrukturals = [], meta } =
        props.pejabatStrukturals ?? {}
                                                ...
                                                <TableRow key={item.id}>
                                                    ...
                                                    <TableCell>
                                                        <div className="flex gap-2">
                                                            ...
                                                            >
                                                                <Link
                                                                    href={`/redesign/backoffice/profil/pejabat-struktural/${item.id}/edit`}
                                                                >

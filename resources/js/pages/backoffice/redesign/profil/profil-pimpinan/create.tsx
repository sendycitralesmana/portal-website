...
import { ArrowLeft, RotateCcw, Save, FileText, User } from 'lucide-react';
import React from 'react';
import AppLayoutRedesign from '@/layouts/backoffice-redesign/app-layout-redesign';

interface ProfilPimpinanForm extends Record<string, any> {
    nama: string;
    jabatan: string;
    deskripsi: string;
    foto: File | null;
...
export default function CreateProfilPimpinan() {
    const [isResetting, setIsResetting] = React.useState(false);
    const [imagePreview, setImagePreview] = React.useState<string | null>(null);

    const { data, setData, post, reset, processing, errors } =
        useForm<ProfilPimpinanForm>({
            nama: '',
            jabatan: '',
            deskripsi: '',
            foto: null,
                        ...
                        <form className="space-y-6" onSubmit={onHandleSubmit}>
                            ...
                            <div className="grid gap-1.5">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Tulis deskripsi profil pimpinan..."
                                    className={
                                        errors.deskripsi

...
import { ArrowLeft, RotateCcw, Save, FileText, Scale } from 'lucide-react';
import React from 'react';

interface Kewenangan {
    id: number;
    kategori: string;
    judul: string;
    deskripsi: string;
...
interface EditKewenanganProps {
    kewenangan: Kewenangan;
}

export default function EditKewenangan({
    kewenangan,
}: EditKewenanganProps) {
    ...
    const { data, setData, reset, post, processing, errors } = useForm({
        kategori: kewenangan.kategori ?? '',
        judul: kewenangan.judul ?? '',
        deskripsi: kewenangan.deskripsi ?? '',
                    ...
                    <CardContent className="p-6">
                        <form className="space-y-6" onSubmit={onHandleSubmit}>
                            ...
                            <div className="grid gap-1.5">
                                ...
                                {(kewenangan.gambar || newImagePreview) && (

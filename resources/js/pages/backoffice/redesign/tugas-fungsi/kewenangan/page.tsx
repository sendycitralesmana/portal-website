...
import { FileText, Pencil, Plus, Scale, Search as SearchIcon } from 'lucide-react';

import DeleteDialog from './delete-dialog';
import Filter from './filter';
import KewenanganPagination from './pagination';

const KewenanganPage = (props: any) => {
    const { data: kewenangans = [], meta } = props.kewenangans ?? {};
    ...
    return (
        <AppLayoutRedesign>
            <Head title="Kewenangan">
                <meta name="description" content="Halaman Kewenangan" />
            ...
            <div className="flex w-full flex-col">
                <div className="mb-8 flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
                    <HeaderTitle
                        title="Kewenangan"
                        subtitle="Kelola data kewenangan yang ditampilkan pada halaman tugas dan fungsi."
                        icon={Scale}
                    />
                ...
                <Card>
                            ...
                            <Table className="w-full table-auto">
                                ...
                                <TableBody>
                                    {isLoading ? (
                                        ...
                                        kewenangans.map((item: any, index: number) => (
                    ...
                    <CardFooter className="flex w-full flex-col items-center justify-between border-t py-2 lg:flex-row">
                        <KewenanganPagination meta={meta} />
                    </CardFooter>
                </Card>
            </div>
        </AppLayoutRedesign>

...
import ProgramPerlindunganPagination from './pagination';

const ProgramPerlindunganPage = (props: any) => {
    const { data: programPerlindungans = [], meta } = props.programPerlindungans ?? {};
    ...
    useFilter({
        route: '/redesign/backoffice/tugas-fungsi/program-perlindungan',
        values: params,
        only: ['programPerlindungans'],
            ...
            <div className="flex w-full flex-col">
                <div className="mb-8 flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
                    ...
                    <Button variant="blue" size="lg" asChild>
                        <Link href="/redesign/backoffice/tugas-fungsi/program-perlindungan/create">
                ...
                <Card>
                            ...
                            <Table className="w-full table-auto">
                                ...
                                <TableBody>
                                    {isLoading ? (
                                        ...
                                        programPerlindungans.map((item: any, index: number) => (
                                                ...
                                                <TableCell className="align-top">
                                                    <div className="flex gap-2">
                                                        <Button className="bg-amber-400" variant="link" size="sm" asChild>
                                                            <Link href={`/redesign/backoffice/tugas-fungsi/program-perlindungan/${item.id}/edit`}>
                    ...
                    <CardFooter className="flex w-full flex-col items-center justify-between border-t py-2 lg:flex-row">
                        <ProgramPerlindunganPagination meta={meta} />
                    </CardFooter>
                </Card>
            </div>
        </AppLayoutRedesign>
...
export default ProgramPerlindunganPage;

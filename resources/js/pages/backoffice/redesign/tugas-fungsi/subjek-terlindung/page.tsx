...
import { FileText, Pencil, Plus, Search as SearchIcon, Shield } from 'lucide-react';

import DeleteDialog from './delete-dialog';
import Filter from './filter';
import SubjekTerlindungPagination from './pagination';

const SubjekTerlindungPage = (props: any) => {
    const { data: subjekTerlindungs = [], meta } = props.subjekTerlindungs ?? {};
            ...
            <div className="flex w-full flex-col">
                ...
                <Card>
                            ...
                            <Table className="w-full table-auto">
                                ...
                                <TableBody>
                                    {isLoading ? (
                                        ...
                                        subjekTerlindungs.map((item: any, index: number) => (
                    ...
                    <CardFooter className="flex w-full flex-col items-center justify-between border-t py-2 lg:flex-row">
                        <SubjekTerlindungPagination meta={meta} />
                    </CardFooter>
                </Card>
            </div>
        </AppLayoutRedesign>
...
export default SubjekTerlindungPage;

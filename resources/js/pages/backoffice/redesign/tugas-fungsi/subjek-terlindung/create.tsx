...
interface SubjekTerlindungForm extends Record<string, any> {
    kategori: string;
    judul: string;
    deskripsi: string;
    gambar: File | null;
...
export default function CreatePerwakilanDaerah() {
    ...
    const { data, setData, post, reset, processing, errors } =
        useForm<SubjekTerlindungForm>({
            kategori: 'subjek terlindung',
            judul: '',
            deskripsi: '',
            gambar: null,
        });
    ...
    const onHandleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        post('/redesign/backoffice/tugas-fungsi/subjek-terlindung/store', {
            forceFormData: true,
            onSuccess: () => {
                reset();
                setImagePreview(null);

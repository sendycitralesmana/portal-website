...
interface TindakPidanaTertentu {
    id: number;
    kategori: string;
    judul: string;
    deskripsi: string;
...
interface EditTindakPidanaTertentuProps {
    tindakPidanaTertentu: TindakPidanaTertentu;
}

export default function EditTindakPidanaTertentu({
    tindakPidanaTertentu,
}: EditTindakPidanaTertentuProps) {
    const [isResetting, setIsResetting] = React.useState(false);
    const [newImagePreview, setNewImagePreview] = React.useState<string | null>(null);

    const { data, setData, reset, post, processing, errors } = useForm({
        kategori: tindakPidanaTertentu.kategori ?? '',
        judul: tindakPidanaTertentu.judul ?? '',
        deskripsi: tindakPidanaTertentu.deskripsi ?? '',
    ...
    const onHandleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        post(`/redesign/backoffice/tugas-fungsi/tindak-pidana-tertentu/${tindakPidanaTertentu.id}/update`, {
            forceFormData: true,
        });
    };
                    ...
                    <CardContent className="p-6">
                        <form className="space-y-6" onSubmit={onHandleSubmit}>
                            ...
                            <div className="grid gap-1.5">
                                ...
                                {(tindakPidanaTertentu.gambar || newImagePreview) && (
                                            ...
                                            <div>
                                                ...
                                                <Dialog>
                                                    <DialogTrigger asChild>
                                                        <img
                                                            src={tindakPidanaTertentu.gambar}
                                                            alt="Current"

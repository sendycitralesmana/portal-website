...
import { FileText, Gavel, Pencil, Plus, Search as SearchIcon } from 'lucide-react';

import DeleteDialog from './delete-dialog';
import Filter from './filter';
import TindakPidanaTertentuPagination from './pagination';

const TindakPidanaTertentuPage = (props: any) => {
    const { data: tindakPidanaTertentus = [], meta } = props.tindakPidanaTertentus ?? {};
            ...
            <div className="flex w-full flex-col">
                ...
                <Card>
                        ...
                        <div className="hidden lg:block">
                            <Table className="w-full table-auto">
                                ...
                                <TableBody>
                                    {isLoading ? (
                                    ...
                                    ) : tindakPidanaTertentus.length === 0 ? (
                                        <TableRow>
                                        ...
                                        tindakPidanaTertentus.map((item: any, index: number) => (
                    ...
                    <CardFooter className="flex w-full flex-col items-center justify-between border-t py-2 lg:flex-row">
                        <TindakPidanaTertentuPagination meta={meta} />
                    </CardFooter>
                </Card>
            </div>
        </AppLayoutRedesign>
...
export default TindakPidanaTertentuPage;

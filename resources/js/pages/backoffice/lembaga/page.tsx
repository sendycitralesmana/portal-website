...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Profil Lembaga', href: '/backoffice/lembaga' },
];
...
export default function LembagaPage() {
  ...
  const handleSearch = useRef(
    debounce((query: string) => {
      router.get('/backoffice/lembaga', { search: query }, { preserveState: true, replace: true });
    }, 500)
  ).current;
  ...
  const handleDelete = (id: number) => {
    router.delete(`/backoffice/lembaga/${id}/delete`);
  };
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        <Card className='shadow-md'>
          <CardHeader>
            <CardTitle>Data Profil Lembaga</CardTitle>
          </CardHeader>
          <CardContent className='space-y-8'>
            <div className='flex items-center justify-between'>
              ...
              {institution ? (
                <Button>
                  <Link href={`/backoffice/lembaga/${institution.id}/edit`} className='flex items-center'>
                    <PenBox className="mr-1" /> Edit
                  </Link>
                </Button>
              ) : (
                <Button>
                  <Link href='/backoffice/lembaga/add' className='flex items-center'>
            ...
            {institution ? (
              <div className=" mx-auto px-4 py-8 space-y-16 text-justify text-sm md:text-base">
                ...
                {/* SEJARAH */}
                <section>
                  <h2 className="font-bold text-blue-900 uppercase mb-2 dark:text-white">Sejarah Lahirnya LPSK</h2>
                  <div
                ...
                {/* DASAR HUKUM */}
                <section>
                  <h2 className="font-bold text-blue-900 uppercase mb-2 dark:text-white">Dasar Hukum</h2>
                  <div
                    className="text-gray-700 leading-relaxed prose prose-sm md:prose-base dark:text-white"
                  ...
                  {institution.document_url && (
                    <div className="mt-4">
                      <a
                        ...
                        target="_blank"
                      >
                        <FileText size={16} /> Unduh Dokumen Dasar Hukum
                      </a>
                    </div>
                  )}
                </section>
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                  ...
                  <div className="md:col-span-2 order-2 md:order-1">
                    <h2 className="font-bold text-blue-900 uppercase mb-2 dark:text-white">Visi</h2>
                    <div
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                  ...
                  <div className="md:col-span-2 order-2">
                    <h2 className="font-bold text-blue-900 uppercase mb-2 dark:text-white">Misi</h2>
                    <div
                      className="text-gray-700 leading-relaxed prose prose-sm md:prose-base text-justify dark:text-white"
                ...
                <section className="text-center">
                  <h2 className="font-bold text-blue-900 uppercase mb-4 dark:text-white">Tugas dan Wewenang</h2>
                  <div

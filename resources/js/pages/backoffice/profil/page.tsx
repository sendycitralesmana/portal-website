  ...
  useEffect(() => {
    ...
    const handleSearch = useRef(
        debounce((query: string) => {
            router.get('/backoffice/profil', { search: query }, { preserveState: true, replace: true });
        }, 500),
    ).current;
    ...
    const handleDelete = (id: number) => {
        router.delete(`/backoffice/profil/${id}/delete`);
    };
            ...
            <Card className='shadow-md'>
                ...
                <CardContent className='space-y-8'>
                    <div className='flex items-center justify-between'>
                        ...
                        <Button>
                            <Link href='/backoffice/profil/add' className='flex items-center'>
                                <Plus /> Tambah
                            </Link>
                        </Button>
                    </div>
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/backoffice/profil/${app.id}/edit`} className=' flex items-center'>
                                                            <PenBox className='ml-1 mr-1' /> Ubah
                                                        </Link>
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/backoffice/profil/${app.id}/detail`} className=' flex items-center'>

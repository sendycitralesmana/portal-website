...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/backoffice/tentang-kami/add',
    },
];

const AddTentangKamiPage = () => {
    ...
    function handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        post(route('backoffice.tentang-kami.store'));
    }

    return (
        <AppLayoutEn breadcrumbs={breadcrumbs}>
            <Head title="Tambah Tentang Kami" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">

                <Card>
                    <CardHeader>
                        <CardTitle>Tambah Tentang Kami</CardTitle>
                    </CardHeader>
                    <CardContent>
...
export default AddTentangKamiPage
...
export default function RepresentativeDetailPage() {
  ...
  return (
    <AppLayoutEn breadcrumbs={breadcrumbs}>
      <Head title="Detail Representative">
        <meta name="description" content="Halaman Detail Representative" />
      ...
      <div className="flex flex-col gap-4 p-4">
        <Card className="shadow-md">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button asChild>
              <Link href={`/backoffice/en/representative/${representative.id}/edit`} className="flex items-center gap-1">
                <PenBox size={18} /> Edit
              </Link>
            </Button>
          </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="w-full max-w-md mx-auto aspect-[4/3] overflow-hidden rounded shadow">
                    {hasValidCoordinates ? (
                      ...
                      <p className="text-base italic text-muted-foreground">Location not available</p>
                    )}
                </div>
            </div>

            <div className="space-y-2 text-sm sm:text-base">
              <p><strong>Office:</strong> {representative.office}</p>

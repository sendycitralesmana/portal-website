...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/backoffice/en/representative/edit',
    },
];
...
const EditPerwakilanPage = () => {
    ...
    function handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        post(route('backoffice.representative.update', representative.id));
    }

    return (
        <AppLayoutEn breadcrumbs={breadcrumbs}>
            <Head title="Edit Representative" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">

                <Card>
                    <CardHeader>
                        <CardTitle>Edit Representative</CardTitle>
                    </CardHeader>
                    <CardContent>

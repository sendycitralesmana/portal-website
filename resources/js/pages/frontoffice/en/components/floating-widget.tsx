...
export default function EnFloatingTabButtons() {
    const [voiceEnabled, setVoiceEnabled] = useState(false);
    const [showAccessibility, setShowAccessibility] = useState(false);
    const [textSize, setTextSize] = useState(100);
    const [lineHeight, setLineHeight] = useState(1);
    const [textSpacing, setTextSpacing] = useState("medium");
    ...
    return (
        <>
            <div className="fixed top-1/2 left-12 -translate-y-1/2 z-50">
                {/* <button className="bg-[#EE2D11] text-white font-semibold text-sm px-2 py-4 rounded-br-md rounded-bl-md rotate-[-90deg] origin-bottom-left hover:bg-[#c8250e] transition cursor-pointer">
                    Feedback & Complaints
                </button> */}
                <a
                ...
                >
                    <section className="relative p-5 mb-4 overflow-auto bg-white dark:bg-zinc-900 shadow-md pointer-events-auto w-80 rounded-lg">
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <p className="font-semibold mb-2">Adjust Text Size</p>
                                <div className="flex items-center justify-between">
                            ...
                            <div>
                                <p className="font-semibold mb-2">Adjust Line Height</p>
                                <div className="flex items-center justify-between">
                            ...
                            <div>
                                <p className="font-semibold mb-2">Text Spacing</p>
                                <div className="flex gap-2">
                                    <Button variant={textSpacing === "small" ? "default" : "outline"} onClick={() => setTextSpacing("small")}>Small</Button>
                                    <Button variant={textSpacing === "medium" ? "default" : "outline"} onClick={() => setTextSpacing("medium")}>Medium</Button>
                                    <Button variant={textSpacing === "large" ? "default" : "outline"} onClick={() => setTextSpacing("large")}>Large</Button>
                                </div>
                            </div>

...
const EnApplicationSection: React.FC<Props> = ({ application }) => {
  return (
            ...
            >
              ...
              <CardContent className="relative z-20 p-3 h-full flex items-end">
                <a
                  target="_blank"
                  href={url}
                  className="text-white font-semibold text-xs sm:text-sm hover:underline"
                >
                  {title}
                </a>
              </CardContent>
...
export default EnApplicationSection;

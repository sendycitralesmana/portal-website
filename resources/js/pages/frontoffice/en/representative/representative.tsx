                ...
                >
                  <div className="space-y-6">
                    ...
                    <div className="-mt-3">
                      ...
                      <p className="font-bold xl:text-2xl mb-1 text-[color:var(--primary-navy)] dark:text-white">Address</p>
                      <p className="text-base sm:text-lg text-justify">{item.address}</p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        <p className="font-bold xl:text-2xl mb-2 text-[color:var(--primary-navy)] dark:text-white">Contact</p>
                      ...
                      <div>
                        <p className="font-semibold xl:text-2xl mb-1  dark:text-white">Social Media</p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="px-8">
                      <h4 className="font-bold text-lg mb-2 text-[color:var(--primary-navy)] dark:text-white">Location Map</h4>
                      <div className="w-full h-[320px] rounded-lg shadow overflow-hidden">
                        {hasValidCoordinates ? (

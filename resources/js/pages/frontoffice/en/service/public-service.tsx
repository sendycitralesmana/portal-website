...
const PublicServicePage = () => {
  return (
    <div className="space-y-10">
      ...
      <Hero title="Public Service Standard at LPSK" />
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            <Card>
              ...
              <CardContent className="text-center">
                <p>
                LPSK Regulation No. 1 of 2024 concerning Service Standards in the LPSK Environment
                </p>
              </CardContent>
              <CardFooter className="flex justify-center place-items-center">
                <Button asChild className="bg-blue-900 hover:bg-blue-800">
                  <a
                    target="_blank"
                    href="/en/service/public-service-preview"
...
PublicServicePage.layout = (page: React.ReactNode) => <MainLayout children={page} />;

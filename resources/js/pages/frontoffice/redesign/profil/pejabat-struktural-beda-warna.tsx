  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col items-center text-center 
                dark:shadow-amber-900/30 rounded-xl 
                 shadow-md hover:shadow-xl 
                 border border-amber-100 dark:border-amber-900/40
                 transition-all duration-300 p-6"
    >
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-800 to-amber-500 rounded-t-xl"></div>

      {showImage && (
        <div className="relative w-28 h-36 rounded-lg overflow-hidden shadow-sm mb-4 ring-2 ring-amber-100 dark:ring-amber-900/40">
          <img
            src={imageSrc}
            alt={nama}
  ...
  return (
    <section className="space-y-8">
      <div className="text-center">
        <h2 className="text-xl font-bold text-amber-900 dark:text-amber-200 inline-block relative">
          {title}
        </h2>
        <div className="mx-auto mt-3 w-20 h-1 bg-gradient-to-r from-amber-800 to-amber-500 rounded-full"></div>
      </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-red-700 to-red-900 py-6 md:py-8 shadow-md">
          <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4 py-16 space-y-24">
          ...
          <Section
            ...
            cols="grid-cols-2 md:grid-cols-2 lg:grid-cols-3"
            showImage={false}
          />

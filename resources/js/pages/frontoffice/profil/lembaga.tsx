          ...
          {institution && (
            <div className=" space-y-20 text-justify text-gray-800 text-sm md:text-base">
              ...
              <section className="space-y-3">
                <h2 className="text-lg font-bold text-blue-900 uppercase dark:text-white">Sejarah Lahirnya LPSK</h2>
                <div
              ...
              {/* Dasar Hukum */}
              <section className="space-y-3">
                <h2 className="text-lg font-bold text-blue-900 uppercase dark:text-white">Dasar Hukum</h2>
                <div
